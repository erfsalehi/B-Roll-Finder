...
OPTIONS = [
    ...
    {"key": "overlay_style", "label": "Overlay style", "type": "choice", "env": "OVERLAY_STYLE",
     "choices": ["bold_yellow", "clean_white", "neon", "boxed_news"],
     "fmt": lambda v: {"bold_yellow": "Bold Yellow", "clean_white": "Clean White",
