...
class DownloadManager:
    ...
    def add_download(self, url: str, output_path: str, quality: str, source: str = 'youtube') -> str:
    ...
    def start_download(self, task_id: str):
        ...
        if state['status'] in ['queued', 'error', 'cancelled']:
            ...
            if state['source'] == 'youtube':
                self.executor.submit(download_video, state['url'], state['output_path'], state['quality'], state)
            else:
                self.executor.submit(download_direct_video, state['url'], state['output_path'], state)
